...
import { useChatWithSession } from './chat/useChatWithSession';
...
export default function FloatingWidget({ position = 'bottom-right', initialState = 'collapsed' }: WidgetProps) {
  ...
  const { messages, currentSession, sessions, sendMessage, isLoading, startNewSession, loadSession, deleteSession } = useChatWithSession();
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-900/50">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Select a session to load or create a new one.
                </p>
              </div>
